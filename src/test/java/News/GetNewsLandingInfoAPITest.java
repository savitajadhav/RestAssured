...
public class GetNewsLandingInfoAPITest extends TestBase {
	...
	public GetNewsLandingInfoAPITest() throws IOException {
		super();
	}
	...
	@Test
	public void getNewsLandingInfoTest() throws IOException {
...
//		login.loginTest("iphone", "iphone@123");
		...
		response = given().
				...
				body(Payload.renderNewsLandingInfo()).
				when().
				post(url).
	...
	@Test
	public void verifyStausCodeForNewsLandingPage() {
		log.info("Test Case2: Verify that API returns the correct status code for 'News Landing' request");
